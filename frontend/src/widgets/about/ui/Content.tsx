	...
	return (
		<Container sx={{ py: 4 }}>
			...
			<Typography variant='body1'>
				Тессеракт задумывался как онлайн чат, где каждый пользователь,
				задав себе никнейм, может погрузиться в настоящую онлайн комнату
				физиков, задать интересующие его вопросы по теме и узнать что-то
				новое.
			</Typography>
